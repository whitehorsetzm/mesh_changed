 ...
 * ------------------------------------------------------------------------------
 * ------------------------------------------------------------------------------*/
#ifndef __iso3d_error_h__
#define __iso3d_error_h__
...
/* 两个相邻单元拓扑上完全重合 two neighboring elements are topogically identical */
#define ERR_OVERLAP_ELEM 9
